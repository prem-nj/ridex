...
function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] =
    useState<Tab>('partner')

  const [partnerReviews, setPartnerReviews] =
    useState<any[]>([])

  const [pendingkyc, setPendingkyc] =
    useState<any[]>([])

  const [vehicleReviews, setVehicleReviews] =
    useState<any[]>([])
