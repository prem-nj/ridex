            ...
            >
                <div className='relative text-center'>
                    ...
                    <button className='absolute left-0 top-0 w-9 h-9 rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-100 transition'
                        onClick={() => router.back()}
                    ><ArrowLeft size={18} color='black' /></button>
                    ...
                    <div className='grid grid-cols-2 sm:grid-cols-3 gap-3'>
                      ...
                      <div>
                        ...
                        <input
                            ...
                            id='vn'
                            className='mt-2 w-full border-b border-gray-300 pb-2 text-black rhytext-sm focus:outline-none focus:border-black transition' />
                    </div>
 <div>
                        ...
                        <input
                            ...
                            id='vm'
                            className='mt-2 w-full border-b border-gray-300 pb-2 text-black text-sm focus:outline-none focus:border-black transition' />
                    </div>
